...
public class ConsoleUI implements View {
    ...
    public ConsoleUI() {
        ...
        FileOperationServise fileOperationServise = null;
        try {
            fileOperationServise = new FileOperationServise();
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        presenter = new Presenter(this, fileOperationServise);
    ...
    private int dayRequest() {
        ...
        boolean flag = true;
        while (flag) {
            System.out.println("Введите день рождения (1-31): ");
