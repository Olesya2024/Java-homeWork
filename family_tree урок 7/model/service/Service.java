...
public class Service {
    ...
    private  FileOperationServise fileOperationServise;

    public Service(FileOperationServise fileOperationServise) {
        this.fileOperationServise = fileOperationServise;
    ...
    public void saveFamilyTree() {
        fileOperationServise.saveFamilyTree(this.familyTree);
    }

    public void loadFamilyTree() throws ClassNotFoundException {
        this.familyTree = fileOperationServise.loadFamilyTree();
    }
}